...
function CherryPickerPage({c, nd, pm, logo}) {
  ...
  const awpExpiry = formatDate(c.expiry_date) || addMonths(c.issue_date || c.issued_at, 12);
  ...
  const bucketSerial = val(bk.serial_number) || val(bk.platform_serial) || 
                       (serialNo !== "—" ? serialNo + "-BKT" : "BUCKET-" + Date.now().toString().slice(-6));
  ...
  function bkResult(v) {
    ...
    const isBad = /fail|repair|required/i.test(String(v));
    ...
    <>
        ...
        <div className="pro-body">
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:8,flexShrink:0}}>
            <div style={{border:"1px solid #1e3a5f",borderRadius:4,padding:"7px 10px",background:"#f4f8ff"}}>
              ...
              <div style={{marginTop:4}}>
                <span style={{fontSize:8,fontWeight:700,border:"1px solid #1e3a5f",padding:"2px 7px",borderRadius:3,background:"#fff"}}>Expiry (12 months): {awpExpiry}</span>
              </div>
            </div>
          ...
          <table className="pro-lt">
            ...
            <tbody>
              ...
              <tr><td>SWL at Test Config</td><td>—</td><td>—</td><td style={{fontWeight:800}}>{bm.swl_at_actual_config || swl || "—"}</td></tr>
          ...
          <div className="pro-cg">
            <div className="pro-cc">
              ...
              <CI label="LMI Tested" result={bm.lmi_test||"PASS"}/>
            </div>
            <div className="pro-cc">
              <div className="pro-csec">Safety</div>
              <CI label="Hydraulics" result={cl.hydraulics_result||"PASS"}/>
      ...
      <div className={`pro-page${pm ? " pm" : ""}`}>
        ...
        <div className="pro-body">
          ...
          <div className="pro-stl" style={{borderLeftColor:"#f97316"}}>Bucket / Platform Details</div>
          <table className="bk-t">
            <thead><tr><th>Item</th><th>Value</th></tr></thead>
            <tbody>
              <tr><td>Bucket / Platform Serial Number</td><td style={{fontFamily:"monospace",fontWeight:700}}>{bucketSerial}</td></tr>
          ...
          <div className="pro-stl" style={{borderLeftColor:"#f97316"}}>Inspection Results</div>
          <table className="bk-t">
            ...
            <tbody>
              ...
              <tr><td>Overload Device</td><td>{bkResult(bk.overload_device || "PASS")}</td></tr>
