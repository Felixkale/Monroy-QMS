...
const CSS=`
  ...
  .cs-sig-card-title{font-size:8.5px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#3b6ea5;margin-bottom:12px;display:flex;align-items:center;gap:8px}
  ...
  .cs-sig-label{font-size:7.5px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#3b6ea5;margin-bottom:6px}
  .cs-sig-name{font-size:10px;color:#0b1d3a;font-weight:700;margin-top:6px}
  .cs-sig-role{font-size:8.5px;color:#64748b;margin-top:1px}
  .cs-sig-img-wrap{background:#fff;border:1px solid #1e3a5f;border-radius:5px;min-height:52px;display:flex;align-items:flex-end;padding:4px 8px;margin-bottom:4px}
  .cs-legal{padding:8px 22px 8px;flex-shrink:0}
  ...
  .pro-pf-wrap{border:1px solid #1e3a5f;border-radius:5px;overflow:hidden;display:flex;align-items:center;padding:7px 14px;gap:18px;background:#f4f8ff}
  .pro-pass{color:#15803d;font-size:11px;font-weight:900;background:#dcfce7;padding:4px 14px;border-radius:4px;border:1px solid #86efac}
  .pro-fail{color:#9ca3af;font-size:11px;font-weight:700}
  .pro-fail-active{color:#b91c1c;font-size:11px;font-weight:900;background:#fee2e2;padding:4px 14px;border-radius:4px;border:1px solid #fca5a5}
  /* tables */
  ...
  /* MCIR */
  .pro-mhdr{display:flex;align-items:flex-start;justify-content:space-between;border:1px solid #1e3a5f;border-radius:5px;padding:9px 12px;background:#f4f8ff;margin-bottom:5px}
  ...
  .pro-p{color:#15803d;font-weight:900;font-size:9px;width:16px;text-align:center}
  .pro-f{color:#b91c1c;font-weight:900;font-size:9px;width:16px;text-align:center}
  .pro-na{color:#9ca3af;font-size:7.5px;width:16px;text-align:center}
  /* hook/rope tables */
  ...
  .pro-sgline{border-bottom:1px solid #1e3a5f;min-height:40px;display:flex;align-items:flex-end;padding-bottom:3px;margin-bottom:3px}
...
/* info table — used by all pro pages */
      ...
      <div className="pro-sigg">
        <div>
          ...
          <div className="pro-sgline">
            <img src={sigUrl} alt="sig" style={{maxHeight:36,maxWidth:100,objectFit:"contain"}} onError={e=>e.target.style.display="none"}/>
          </div>
...
function CraneLoadTestPage({c,pn,tone,pm,logo}){
  ...
  return(
    <div className={`pro-page${pm?" pm":""}`}>
      <ProHdr logoUrl={logo}/>
      <div style={{height:4,background:"linear-gradient(90deg,#22d3ee,#3b82f6 55%,#a78bfa)",flexShrink:0}}/>
      <div className="pro-body">
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:8,marginTop:4}}>
          <div>
            <div className="pro-cb">
              ...
              {sliCertNo&&<div className="pro-cb-num" style={{fontWeight:900,fontSize:11,color:"#0b1d3a"}}>{sliCertNo}</div>}
            </div>
            <div className="pro-cb">
              <div className="pro-cb-lbl">Load Test Certificate</div>
              <div className="pro-cb-yes">YES</div>
              {certNumber&&<div className="pro-cb-num">{certNumber}</div>}
            </div>
            {expiryDate&&<div style={{fontSize:10,fontWeight:800,color:"#0b1d3a",marginTop:4,border:"1px solid #1e3a5f",padding:"3px 8px",display:"inline-block",borderRadius:4}}>expire date: {expiryDate}</div>}
          </div>
        ...
        <table className="pro-lt">
          <thead>
            <tr>
              <th rowSpan={2} style={{textAlign:"left",width:140}}>Details of applied Load</th>
    ...
    <div className={`pro-page${pm?" pm":""}`}>
      ...
      <div className="pro-body">
        ...
        <div className="pro-mhdr">
          <div>
            {expiryDate&&<div style={{fontSize:10,fontWeight:800,color:"#0b1d3a",marginBottom:3}}>Validity: {expiryDate}</div>}
          ...
          <div className="pro-mf">
            <div className="pro-mfr"><span>Annually:</span><span style={{fontSize:14}}>&#10003;</span></div>
        ...
        <div className="pro-cg">
          ...
          <div className="pro-cc">
            ...
            <CI label="Fly-Jib Condition (Visual Inspection)"/><CI label="Outrigger Pads Condition" result={outriggers}/>
            ...
            <CI label="Tele Sections checked for damage" result={structural}/><CI label="Tele's checked for bending"/>
      ...
      <div className="pro-body">
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginTop:4}}>
          <div style={{border:"1px solid #1e3a5f",borderRadius:5,padding:"9px 12px",background:"#f4f8ff"}}>
            ...
            {expiryDate&&<div style={{display:"inline-block",border:"1px solid #1e3a5f",borderRadius:4,padding:"3px 9px",marginTop:6,fontSize:9,fontWeight:700,color:"#0b1d3a",background:"#fff"}}>Expiry date: {expiryDate}</div>}
          </div>
        ...
        {!isRope&&(
          <>
            ...
            <table className="pro-hrt">
              <thead>
                <tr>
                  <th style={{textAlign:"left",width:"40%"}}>Hook inspection criteria</th>
                  <th colSpan={2}>Hook 1 (Main)</th>
                  <th colSpan={2}>Hook 2 (Aux)</th>
                  <th colSpan={2}>Hook 3</th>
                </tr>
              </thead>
              <tbody>
  ...
  return(
    <div className={`pro-page${pm?" pm":""}`}>
      ...
      <div className="pro-body">
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginTop:4}}>
          <div style={{border:"1px solid #1e3a5f",borderRadius:5,padding:"9px 12px",background:"#f4f8ff"}}>
            <div style={{fontSize:13,fontWeight:900,color:"#0b1d3a"}}>Pressure Vessel Inspection</div>
            <div style={{fontSize:11,fontWeight:700,color:"#0e7490",marginTop:3}}>{certNumber}</div>
            {expiryDate&&<div style={{display:"inline-block",border:"1px solid #1e3a5f",borderRadius:4,padding:"3px 9px",marginTop:6,fontSize:9,fontWeight:700,color:"#0b1d3a",background:"#fff"}}>Expiry date: {expiryDate}</div>}
          </div>
          <div className="pro-compbox">
            <div>
        ...
        <table className="pro-pv"><thead>
          <tr><th>Vessel Type</th><th>Serial Number</th><th>Capacity / Volume</th><th>MAWP ({pressureUnit})</th><th>Test Pressure ({pressureUnit})</th><th>Design Pressure ({pressureUnit})</th></tr>
        </thead><tbody>
          <tr>
        ...
        <div style={{fontSize:8,color:"#4b5563",lineHeight:1.55,border:"1px solid #1e3a5f",borderRadius:5,padding:"6px 10px",background:"#f4f8ff",textAlign:"center",fontWeight:700}}>
  ...
  return(
    <div className={`pro-page${pm?" pm":""}`}>
      ...
      <div className="pro-body">
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginTop:4}}>
          <div style={{border:"1px solid #1e3a5f",borderRadius:5,padding:"9px 12px",background:"#f4f8ff"}}>
            <div style={{fontSize:13,fontWeight:900,color:"#0b1d3a"}}>Wire Rope Sling Inspection</div>
            <div style={{fontSize:11,fontWeight:700,color:"#0e7490",marginTop:3}}>{certNumber}</div>
            {expiryDate&&<div style={{display:"inline-block",border:"1px solid #1e3a5f",borderRadius:4,padding:"3px 9px",marginTop:6,fontSize:9,fontWeight:700,color:"#0b1d3a",background:"#fff"}}>Expiry date: {expiryDate}</div>}
          </div>
          <div className="pro-compbox">
            <div><div style={{fontSize:11,fontWeight:800,color:"#0b1d3a"}}>Compliance Certificate</div><div style={{fontSize:9,color:"#64748b"}}>to be issued</div></div>
            <div style={{fontSize:28,color:tone.label==="PASS"?"#15803d":"#b91c1c",fontWeight:900}}>{tone.label==="PASS"?"✓":"✗"}</div>
          </div>
        </div>
        ...
        <table className="pro-pv"><thead>
          <tr><th>Type</th><th>Diameter (mm)</th><th>Length (m)</th><th>No. of Legs</th><th>Construction</th><th>Core Type</th><th>SWL</th></tr>
        </thead><tbody>
          <tr>
            ...
            <td style={{background:"#fff",fontWeight:700}}>{swl||"—"}</td>
          </tr>
        </tbody></table>
...
/* ══════════════════════════════════════════════════════════
   PAGE: MACHINE INSPECTION (Cherry Picker / Telehandler / Forklift)
══════════════════════════════════════════════════════════ */
    ...
    <div className={`pro-page${pm?" pm":""}`}>
      ...
      <div className="pro-body">
        ...
        {(isCherryPicker||isTelehandler)&&(maxHeight||boomLen)&&(
          <table className="pro-st" style={{marginBottom:4}}><tbody>
        ...
        <div className="pro-cg">
          <div className="pro-cc">
            ...
            <CI label="Cab / ROPS Condition" result="PASS"/>
            <CI label="Controls Marked Correctly" result="PASS"/>
            <CI label="Controls Return to Neutral" result="PASS"/>
            <CI label="Level / Inclinometer Gauge" result="PASS"/>
            <CI label="Reverse Warning / Alarm" result="PASS"/>
            <CI label="Load Chart Available" result="PASS"/>
            <CI label="Horn" result="PASS"/>
            <CI label="Lights (Work / Rotating)" result="PASS"/>
            <CI label="Tires / Ground Pads" result={tires}/>
            <CI label="Brakes (Service &amp; Park)" result={brakes}/>
            <CI label="Fire Extinguisher" result="PASS"/>
            <CI label="Seat Belt &amp; Operator Seat" result="PASS"/>
            <CI label="SWL Correctly Indicated" result="PASS"/>
            <CI label="Oil Leaks (General)" result={oilLeaks}/>
            {isForklift&&<>
              <div className="pro-csec">Forks &amp; Carriage</div>
              <CI label="Fork Condition (No Cracks / Bends)" result={forks}/>
              <CI label="Fork Retention Pins Secure" result="PASS"/>
              <CI label="Carriage &amp; Backrest" result="PASS"/>
              <CI label="Mast Condition &amp; Chains" result={structural}/>
              <CI label="Mast Chain Lubrication" result="PASS"/>
              <CI label="Tilt Cylinders (No Leaks)" result={oilLeaks}/>
            </>}
            {(isCherryPicker||isTelehandler)&&<>
              <div className="pro-csec">Boom &amp; Attachment</div>
              <CI label="Boom Structure (Visual)" result={boom}/>
              <CI label="Boom Pins &amp; Connections" result={boom}/>
              ...
              <CI label="Boom Extension / Telescope" result={boom}/>
              <CI label="Hydraulic Cylinders (No Leaks)" result={oilLeaks}/>
          ...
          <div className="pro-cc">
            ...
            <CI label="Overload Protection / Cutout" result="PASS"/>
            <CI label="Anti-Two-Block (if fitted)" result={isCherryPicker||isTelehandler?"PASS":"PASS"} na={isForklift}/>
            <CI label="SLI / LMI System" result={pn["LMI"]||"PASS"} na={isForklift}/>
            <CI label="Outrigger Interlocks" result={outriggers} na={isForklift}/>
            <CI label="Outrigger Pads Condition" result={outriggers} na={isForklift}/>
            <CI label="Outrigger Beams (Visual)" result={outriggers} na={isForklift}/>
            ...
            <CI label="Fuel / Battery Level" result="PASS"/>
...
/* ══════════════════════════════════════════════════════════
   GENERIC CERTIFICATE (all other types)
══════════════════════════════════════════════════════════ */
              ...
              <div className="cs-fields">
                <div className="cs-field" style={{gridColumn:"1/-1",background:"#f4f8ff"}}>
                  <div className="cs-fv" style={{fontSize:8.5,color:"#4b5563",lineHeight:1.55,fontWeight:400}}>
                    ...
                    of the above equipment has been carried out in full compliance with the requirements of the said Act and applicable regulations.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="cs-sig-grid">
                <div>
                  ...
                  <div className="cs-sig-img-wrap">
                    <img src="/Signature" alt="sig" style={{maxHeight:44,maxWidth:120,objectFit:"contain"}} onError={e=>e.target.style.display="none"}/>
                  </div>
...
export default function CertificateSheet({certificate:c,index=0,total=1,printMode=false}){
  ...
  if(_isMobileCrane) return wrap(
    <>
      ...
      <div className="pro-pb" style={{height:pm?0:16}}/>
      <CraneChecklistPage c={c} pn={pn} pm={pm} logo={logo}/>
    </>
  );

  if(_isHook||_isCraneRope) return wrap(
    <HookRopePage c={c} pn={pn} tone={tone} pm={pm} logo={logo} isRope={_isCraneRope&&!_isHook}/>
  );

  if(_isWireRopeSling) return wrap(
    <WireRopeSlingPage c={c} pn={pn} tone={tone} pm={pm} logo={logo}/>
  );

  if(_isPV) return wrap(
    <PressureVesselPage c={c} pn={pn} tone={tone} pm={pm} logo={logo} pvNum={index+1}/>
  );

  if(isMachine) return wrap(
    <MachinePage c={c} pn={pn} tone={tone} pm={pm} logo={logo}/>
  );

  /* boom + all other types → generic */
