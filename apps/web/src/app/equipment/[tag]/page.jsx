...
// Mock equipment data - replace with Supabase query
const allEquipment = {
  "PV-0041": {
    ...
    <AppLayout>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:16, marginBottom:28 }}>
        <div>
          ...
          <p style={{ color:"#64748b", margin:0 }}>{equipment.serial} · {equipment.type} · {equipment.client}</p>
        </div>
        <div style={{ display:"flex", gap:8, flexWrap:"wrap" }}>
          ...
          <button onClick={() => alert("Edit feature coming soon")} style={{
            ...
            color:C.purple, fontWeight:700, fontSize:12, cursor:"pointer", fontFamily:"inherit",
          }}>✏️ Edit</button>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))", gap:12, marginBottom:22 }}>
        {[
          ...
          { label:"Year Built", value:equipment.year, color:C.yellow },
        ].map(s=>(
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))", gap:16 }}>
          <div style={{
            ...
            {[
              ...
              <div key={f.label} style={{ display:"flex", justifyContent:"space-between", padding:"10px 0", borderBottom:"1px solid rgba(255,255,255,0.04)" }}>
                <span style={{ color:"#64748b", fontSize:12 }}>{f.label}</span>
                <span style={{ color:"#e2e8f0", fontWeight:600, fontSize:12 }}>{f.value}</span>
              </div>
            ))}
          </div>
