...
// Equipment types that have a lanyard component
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { error: certError } = await supabase.from("certificates").insert([{
        ...
        // ── NEW: store lanyard serial no on the certificate too ──
        lanyard_serial_no:     formData.lanyard_serial_no || null,
        // ────────────────────────────────────────────────────────
    ...
    <AppLayout title="Register Equipment">
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:16, marginBottom:24 }}>
          ...
          {/* ── NEW: Lanyard Serial No — shown only for harness/fall-arrest ── */}
          {hasLanyardField && (
            <div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:16, marginBottom:24 }}>
          ...
          {isPressureEquipment && (<>
            ...
            <div><label style={labelStyle}>Design Pressure (kPa)</label>
              <input style={inputStyle} type="text" name="design_pressure" value={formData.design_pressure} onChange={handleChange} placeholder="Manual text, unit is kPa" /></div>
            <div><label style={labelStyle}>Working Pressure (kPa)</label>
              <input style={inputStyle} type="text" name="working_pressure" value={formData.working_pressure} onChange={handleChange} placeholder="Manual text, unit is kPa" /></div>
            <div><label style={labelStyle}>Test Pressure (kPa)</label>
              <input style={inputStyle} type="text" name="test_pressure" value={formData.test_pressure} onChange={handleChange} placeholder="Manual text, unit is kPa" /></div>
          ...
          {isLiftingEquipment && (<>
            <div><label style={labelStyle}>SWL (Tons)</label>
              <input style={inputStyle} type="text" name="safe_working_load" placeholder="Manual text, unit is Tons" value={formData.safe_working_load} onChange={handleChange} /></div>
            <div><label style={labelStyle}>Proof Load (Tons)</label>
              <input style={inputStyle} type="text" name="proof_load" placeholder="Manual text, unit is Tons" value={formData.proof_load} onChange={handleChange} /></div>
            <div><label style={labelStyle}>Lift Height</label>
              <input style={inputStyle} type="text" name="lifting_height" placeholder="Fully manual text" value={formData.lifting_height} onChange={handleChange} /></div>
            <div><label style={labelStyle}>Sling Length</label>
              <input style={inputStyle} type="text" name="sling_length" placeholder="Fully manual text" value={formData.sling_length} onChange={handleChange} /></div>
