        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{ display:"flex", justifyContent:"space-between", padding:"10px 0", borderBottom:"1px solid rgba(255,255,255,0.04)", fontSize:13 }}>
              ...
              <span style={{ color:"#00f5c4", fontWeight:700 }}>{s.value}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))", gap:10 }}>
          {userProfile.permissions.map((perm, idx) => (
            <div key={idx} style={{
              ...
              color:"#00f5c4", fontSize:12, fontWeight:600,
            }}>
              ✓ {perm}
            </div>
          ))}
      ...
      <div style={{
        ...
        {userProfile.activity.map((act, idx) => (
          <div key={idx} style={{
            ...
            borderBottom: idx < userProfile.activity.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
          }}>
            <div style={{
