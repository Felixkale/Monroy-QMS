      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))", gap:14 }}>
        {filtered.map(u=>(
          <div key={u.id} onClick={() => handleUserClick(u.id)} style={{
            ...
            borderRadius:14, padding:"20px", cursor:"pointer", transition:"all 0.25s",
          }}
          onMouseEnter={e=>{ e.currentTarget.style.borderColor="rgba(124,92,252,0.5)"; e.currentTarget.style.transform="translateY(-4px)"; }}
          onMouseLeave={e=>{ e.currentTarget.style.borderColor="rgba(124,92,252,0.25)"; e.currentTarget.style.transform="translateY(0)"; }}>
