  ...
  return (
    <AppLayout title="Register Client">
      ...
      >
        ...
        >
          <h3 style={{ fontSize: 14, fontWeight: 700, color: "#fff", margin: "0 0 20px" }}>
            🏢 Company Details
          </h3>
        ...
        >
          ...
          {form.company_name && (
            ...
            >
              ...
              {form.industry && (
                <div style={{ fontSize: 12, color: C.blue, marginBottom: 4 }}>
                  🏭 {form.industry}
                </div>
              )}
              ...
              <div style={{ fontSize: 12, color: "#94a3b8" }}>
                📍 {[form.address, form.city, "Botswana"].filter(Boolean).join(", ")}
              </div>
            </div>
          )}
        </div>
