...
export default function NCRCreatePage() {
  ...
  const source = useMemo(
    () => ({
      source: nz(searchParams.get("source")),
      certificate_id: nz(searchParams.get("certificate_id")),
      certificate_number: nz(searchParams.get("certificate_number")),
      inspection_number: nz(searchParams.get("inspection_number")),
      asset_tag: nz(searchParams.get("asset_tag")),
      asset_name: nz(searchParams.get("asset_name")),
      equipment_description: nz(searchParams.get("equipment_description")),
      equipment_type: nz(searchParams.get("equipment_type")),
      client_name: nz(searchParams.get("client_name")),
      result: nz(searchParams.get("result")),
      issue_date: nz(searchParams.get("issue_date")),
      expiry_date: nz(searchParams.get("expiry_date")),
    }),
    [searchParams]
  );
