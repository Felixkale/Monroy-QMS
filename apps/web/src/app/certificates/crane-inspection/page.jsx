          ...
          <div key={s.id} style={{ display:"flex", alignItems:"center", flex:1, minWidth:0 }}>
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:5, flex:1 }}>
              <div style={{
                ...
                fontSize:14, fontWeight:900, flexShrink:0, transition:"all .2s",
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box}
        ...
        @media(max-width:640px){
          ...
          .wiz-hdr-btns a,.wiz-hdr-btns button{flex:1;text-align:center;justify-content:center}
        }
      `}</style>
        ...
        <div style={{ background:T.surface, border:`1px solid ${T.border}`, borderRadius:18, padding:"14px 20px", marginBottom:20, backdropFilter:"blur(20px)" }}>
          <div className="wiz-hdr">
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <h1 style={{ margin:"0 0 2px", fontSize:22, fontWeight:900, letterSpacing:"-0.02em" }}>Crane Inspection</h1>
              <p style={{ margin:0, fontSize:12, color:T.textDim }}>Crane · Hook · Rope · Pressure Vessels — all saved in one folder</p>
              <div style={{ display:"flex", gap:12, marginTop:8, flexWrap:"wrap" }}>
                <a href="/certificates/machine-inspection"  style={{ fontSize:11, color:T.accent, textDecoration:"none", fontWeight:700 }}>🔧 Machine →</a>
                ...
                <Field label="Client">
                  ...
                  {clients.length > 0 && (
                    <div style={{ fontSize:11, color:T.textDim, marginTop:5 }}>
                      Not listed? <a href="/clients/register" target="_blank" style={{ color:T.accent, textDecoration:"none", fontWeight:700 }}>+ Register new client</a>
                    </div>
                  )}
                </Field>
