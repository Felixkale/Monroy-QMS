...
const TOOLBAR_CSS = `
  *,*::before,*::after{box-sizing:border-box}
  ...
  .pt-content{padding-top:64px;background:#e2e8f0;min-height:100vh;display:flex;align-items:flex-start;justify-content:center;padding-bottom:32px}
  @keyframes spin{to{transform:rotate(360deg)}}
  @media print{
    .pt-toolbar{display:none!important}
    .pt-content{padding:0!important;background:none!important;min-height:unset!important}
  }
`;
  ...
  async function handleSavePDF() {
    ...
    try {
      ...
      await window.html2pdf()
        .set({
          margin:0,
          filename:`${client.replace(/\s+/g,"_")}_Cover_2026.pdf`,
    ...
    <>
      ...
      <div className="pt-toolbar">
        <div>
          ...
          <div className="pt-hint">To download: click Save PDF → select Save as PDF as the printer</div>
        </div>
