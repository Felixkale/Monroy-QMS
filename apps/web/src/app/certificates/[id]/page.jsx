...
function CertificateDetailsInner(){
  ...
  async function handleUnlink(){
    ...
    // If only 1 cert remains in folder, unlink it too (no solo folders)
  ...
  return(
    <AppLayout title="Certificate View">
      ...
      <div className="view-page-pad" style={{
        ...
        {/* Centered, constrained — not full-width stretched */}
          ...
          <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:18,padding:"16px 20px",backdropFilter:"blur(20px)"}}>
            <div className="view-hdr">
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{display:"flex",gap:6,flexWrap:"wrap",alignItems:"center"}}>
                  ...
                  {isLinked&&<span style={{padding:"4px 10px",borderRadius:99,background:T.accentDim,color:T.accent,border:`1px solid ${T.accentBrd}`,fontSize:11,fontWeight:700}}>📁 {record.folder_name||"Linked"} · {bundle.length} certs</span>}
                  {record?.equipment_type&&<span style={{padding:"4px 10px",borderRadius:99,background:T.card,color:T.textMid,border:`1px solid ${T.border}`,fontSize:11,fontWeight:600}}>{record.equipment_type}</span>}
                </div>
              </div>
              ...
              <div className="view-btn-row">
                ...
                <button type="button" onClick={handlePrint} style={S.btnGhostSm2}>
                  🖨 Print
                </button>
            ...
            {linkMsg&&(
              <div style={{marginTop:10,padding:"8px 12px",borderRadius:9,
                background:linkMsg.includes("fail")||linkMsg.includes("Failed")?T.redDim:T.greenDim,
                color:linkMsg.includes("fail")||linkMsg.includes("Failed")?T.red:T.green,
