                ...
                <div className="ce-grid">
                  <F label="Equipment Type">
                    <select name="equipment_type" value={form.equipment_type} onChange={hc} style={IS}>
                      ...
                      {[
                        "── CHAIN & BLOCK HOISTS ──",
                        "Chain Block","Manual Chain Hoist","Electric Chain Hoist","Lever Hoist / Tirfor","Chain Pulley Block","Beam Trolley with Chain Block",
                        "── WIRE ROPE HOISTS ──",
                        "Electric Wire Rope Hoist","Manual Wire Rope Hoist","Wire Rope Winch","Cable Hoist",
                        "── CRANES ──",
                        "Mobile Crane","Overhead Crane / EOT Crane","Gantry Crane","Jib Crane","Knuckle Boom Crane","Loader Crane","Crawler Crane","Tower Crane","Monorail Hoist","Davit Crane","Vacuum Lifter Crane","Telescopic Handler",
                        "── SLINGS ──",
                        "Chain Sling","Wire Rope Sling","Web Sling / Flat Sling","Round Sling","Endless Sling","Multi-Leg Chain Sling","Multi-Leg Wire Rope Sling",
                        "── RIGGING HARDWARE ──",
                        "Shackle — Bow / Anchor","Shackle — D / Dee","Hook — Swivel","Hook — Eye","Hook — Clevis","Swivel","Eye Bolt","Eye Nut","Ring Bolt","Turnbuckle","Rigging Screw","Master Link","Connecting Link","Coupling Link","Chain Shortener / Clutch","Ratchet Lashing Strap",
                        "── BEAMS & SPREADERS ──",
                        "Spreader Beam","Lifting Beam","Adjustable Spreader Beam","Modular Spreader Beam","Lifting Frame","Trunnion Lifting Bar","Pallet Lifter","Coil Lifter","Drum Lifter","Pipe Lifter","Sheet Lifter","Magnetic Lifter","Vacuum Lifter Pad",
                        "── CLAMPS & GRABS ──",
                        "Beam Clamp","Girder Clamp","Plate Clamp — Horizontal","Plate Clamp — Vertical","Pipe Clamp","Slab Clamp","Drum Clamp","Concrete Pipe Lifter","Stone Lifter / Excavator Grab",
                        "── FALL PROTECTION ──",
                        "Safety Harness — Full Body","Safety Harness — Sit","Lanyard — Energy Absorbing","Lanyard — Twin Leg","Rope Lanyard","Self-Retracting Lifeline (SRL)","Fall Arrest Block","Rope Grab / Fall Arrester","Anchor Point","Lifeline System","Safety Rope",
                        "── WINCHES & PULLERS ──",
                        "Electric Winch","Hydraulic Winch","Air / Pneumatic Winch","Hand Winch","Come-Along / Hand Puller","Snatch Block","Pulley Block","Gin Block","Return Block",
                        "── FORKLIFT & MATERIAL HANDLING ──",
                        "Counterbalance Forklift","Reach Truck","Telehandler / Telescopic Forklift","Side Loader","Pallet Jack — Manual","Pallet Jack — Electric","Stackers","Order Picker","Scissor Lift","Boom Lift / Cherry Picker","Personnel Basket / Man Basket","Mast Climbing Platform",
                        "── PRESSURE EQUIPMENT ──",
                        "Pressure Vessel","Air Receiver","Boiler","Autoclave","Hydraulic Tank","Compressor — Air","Compressor — Gas","Accumulator","Gas Cylinder","LPG Tank","Heat Exchanger","Separator","Pipeline Section",
                        "── OTHER MINE EQUIPMENT ──",
                        "Scaffold","Scaffold Hoist","Pipe Rack Lifter","Underground Mine Cage","Skip Hoist","Headgear Sheave","Kibble / Bucket","Rock Drill Rig","Dragline Bucket","Grab Crane Bucket","Locomotive Crane","Rail Mounted Crane","Fire Extinguisher","Other"
                      ].map(t=>t.startsWith("──")?<option key={t} value="" disabled style={{color:"rgba(240,246,255,0.3)",fontWeight:700}}>{t}</option>:<option key={t} value={t}>{t}</option>)}
                    </select>
                  </F>
              ...
              {tab===1&&(
                <div className="ce-grid">
                  <F label="Equipment Type">
                    <select name="equipment_type" value={form.equipment_type} onChange={hc} style={IS}>
                      <option value="">Select type…</option>
                      {["Safety Harness","Lanyard","Rope","Chain Sling","Wire Rope Sling","Web Sling","Shackle","Hook","Swivel","Eye Bolt","Beam Clamp","Spreader Beam","Lifting Beam","Mobile Crane","Overhead Crane","Hoist","Winch","Pulley Block","Pressure Vessel","Air Receiver","Boiler","Autoclave","Compressor","Hydraulic Tank","Fire Extinguisher","Scaffold","Forklift","Other"].map(t=><option key={t} value={t}>{t}</option>)}
                    </select>
                  </F>
                  <F label="Equipment Description">
                    <input name="equipment_description" value={form.equipment_description} onChange={hc} style={IS}/>
