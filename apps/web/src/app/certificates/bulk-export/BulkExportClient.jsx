            ...
            <div style={{display:"flex",gap:10,marginTop:16,flexWrap:"wrap"}}>
              ...
              {previewLoaded&&preview.length>0&&(
                <button onClick={handleExport} disabled={exporting} style={{
                  ...
                  {exporting?(
                    <><span style={{display:"inline-block",width:13,height:13,border:`2px solid ${T.green}`,borderTopColor:"transparent",borderRadius:"50%",animation:"spin 0.7s linear infinite"}}/>Exporting…</>
                  ):(
