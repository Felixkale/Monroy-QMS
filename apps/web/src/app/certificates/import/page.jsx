    ...
    <AppLayout>
      ...
      <div style={{
        ...
        >
          ...
          <p style={{ fontSize:"clamp(14px,3vw,16px)", fontWeight:700, color:"#fff", margin:"0 0 8px" }}>
        ...
        <button
          ...
          style={{
            width:"100%", padding:"12px", borderRadius:10, cursor:!file || uploading ? "not-allowed" : "pointer",
